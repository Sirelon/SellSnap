...
// behavior (no in-app session to force-clear). onDismissed is never invoked: opening a tab
// returns control immediately, with no signal for the tab being closed (SIR-123).
@Composable
